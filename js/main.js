...
const setActive = (elm, selector) => {
  ...
  if (document.querySelector(`${selector}.${activeButton}`) !== null) {
    (_a = document.querySelector(`${selector}.${activeButton}`)) === null ||
    _a === void 0
      ? void 0
      : _a.classList.remove(activeButton);
  }
...
const generateCards = (dataCardsArray) => {
  for (let card of dataCardsArray) {
    ...
    portfolioGrid === null || portfolioGrid === void 0
      ? void 0
...
const modalHandler = (itemId, dataTitle, url) => {
  if (!modalArrayVisited.includes(itemId)) {
    ...
    headerTitle.innerHTML = `${
      dataTitle === null || dataTitle === void 0
        ? void 0
...
toggleTheme === null || toggleTheme === void 0
  ? void 0
  : toggleTheme.addEventListener("click", function () {
      ...
      if (
        !(tab === null || tab === void 0
          ? void 0
          : tab.className.includes(openTheme))
      ) {
...
searchBar === null || searchBar === void 0
  ? void 0
  : searchBar.addEventListener("keyup", (event) => {
      ...
      portfolioItems.forEach((card) => {
        var _a;
        if (
          (_a = card.dataset.item) === null || _a === void 0
            ? void 0
            : _a.includes(inputSearchValue)
        ) {
...
for (const el of openModal) {
  el.addEventListener("click", function () {
    ...
    (_a = document.getElementById(modalId)) === null || _a === void 0
      ? void 0
      : _a.classList.add(isVisible);
  });
}
...
document.addEventListener("click", (event) => {
  ...
  if (event.target === document.querySelector(".modal.is-visible")) {
    (_a = document.querySelector(".modal.is-visible")) === null || _a === void 0
      ? void 0
      : _a.classList.remove(isVisible);
  }
});
...
if (marqueeContent != undefined) {
  root.style.setProperty(
    "--marquee-elms",
    (marqueeContent === null || marqueeContent === void 0
      ? void 0
